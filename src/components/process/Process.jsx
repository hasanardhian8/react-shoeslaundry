...
import ProcessData from "../../datas/ProcessData";
const Process = () => {
  useEffect(() => {
  ...
  return (
    <section id="Pemesanan" className="fade-in py-10 bg-gray-100 pt-28">
      <div className="container mx-auto px-6 text-center ">
        <h1 className="text-3xl font-extrabold">Tata Cara Pemesanan.</h1>
        <div className="py-6 flex space-x-4 justify-center">
          ...
          <Link to="https://wa.me/6285161918478?text=Halo, saya tertarik dengan layanan Anda." target="_blank">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {ProcessData.map((step) => (
            <div key={step.id} className={`p-6 rounded-lg shadow-md ${step.bgColor}`}>
              <div className="flex justify-center items-center text-4xl mb-4">
                <span className={`p-2 bg-blue-400 rounded-full text-white shadow-lg`}>{step.icon}</span>
              </div>
              <h2 className="text-xl font-bold mb-2 text-gray-800">{step.title}</h2>
